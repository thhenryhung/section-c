 ...
 *
 *  2. Exact checks against the real roster, when ../section-c-data/roster.json is
...
const privateRoster = path.resolve(repoRoot, '..', 'section-c-data', 'roster.json')
...
const ALLOWLIST = [
  ...
  // a birthday shoutout, a recurring segment — and this file is deliberately
  // public (the admin panel commits straight to it). A real name here is
  // normal content, not a leak.
  'data/events.json',
]
