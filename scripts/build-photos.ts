 ...
 *
 * Input:  ../section-c-data/photos/<personId>.(jpg|jpeg|png|webp)
 * Output: ../section-c-data/photos.json   — { personId: "data:image/webp;base64,…" }
 *
...
const privateDir = path.resolve(repoRoot, '..', 'section-c-data')
