...
// TODO(section-c): section-j's group photo intentionally not carried over —
// see src/gate/UnlockScreen.tsx for the same note. Drop in section-c's own
// photo and restore an import here.
...
export function WelcomePage() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-700 to-ink-950">
